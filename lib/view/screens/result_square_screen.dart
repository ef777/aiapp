...
import '../base/slider_component_shape.dart';
    NavigatorState  navigatorResultSquareScreen;

class ResultSquareScreen extends StatefulWidget {
  ...
  final StreamController faceDepthStream;
  ...
  ResultSquareScreen({
    ...
    this.stream,
    this.faceDepthStream,
    this.oldImageUrl,
    this.galleryItems = const [],
    this.initialGalleryIndex,
    this.faceDepth,
    this.creative,
    this.isTextToImage = false,
    this.height,
    this.width,
  });

  @override
  _ResultSquareScreenState createState() => _ResultSquareScreenState();
}

class _ResultSquareScreenState extends State<ResultSquareScreen> {
  ...
  void didChangeDependencies() {
     navigatorResultSquareScreen = Navigator.of(context);
              ...
              ColumnSuper(
                ...
                children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          getTranslated('face_depth', context),
                                          maxLines: 1,
                                  ...
                                  child: SliderTheme(
                                    ...
                                    child: Slider(
                                      ...
                                      onChanged: (val) {
                                        ...
                                        widget.faceDepthStream.add(val.toInt());
                                      },
                                    ),
                                  ),
                                )
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          getTranslated('creativity', context),
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                        ),
                                      ),
                  ...
                  Consumer<ImagesProvider>(
                    builder: (context, imagesProvider, child) => Container(
                          ...
                          onTap: () async {
                            ...
                            if (customerInfo.entitlements.active.isNotEmpty ||
                              ...
                              Provider.of<ImagesProvider>(context,
                                ...
                                faceDepthStream: widget.faceDepthStream,
                              );
                            } else {
                              setState(() {
              ...
              Consumer<ImagesProvider>(
                builder: (context, imagesProvider, child) => Container(
                  ...
                  child: FloatingActionButton.extended(
                    ...
                    backgroundColor: Color(0xff898EF8),
                  ),
                ),
              ),
            SizedBox(height: 16),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 8),
                              Text(getTranslated('ai_tools', context),
                                  textAlign: TextAlign.center,
                                  maxLines: 1,
                                  style: GoogleFonts.roboto(
                                    fontSize: 13,
    ...
    return Container(
      ...
      child: Material(
          ...
          child: Ink(
            ...
            width: 38,
            child: InkWell(
              onTap: tmpKey?.currentState?.onTap ?? null,
              child: Center(
                child: LikeButton(
                  key: tmpKey,
  ...
  Future<bool> onLikeButtonTapped(bool isLiked) async {
    ...
    if (favList.contains(widget.imageUrl)) {
      favList.remove(widget.imageUrl);
      prefs.setStringList('favList', favList);
      setState(() {
        liked = false;
      });
    } else {
      favList.insert(0, widget.imageUrl);
      prefs.setStringList('favList', favList);
      setState(() {
        liked = true;
      });
